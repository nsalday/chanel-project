...
public class TitleScreen {
    ...
    public void start() {
        ...
        titleLabel.setFont(Font.loadFont(getClass().getResourceAsStream("/fonts/Mario-Kart-DS.ttf"), 48));
        ...
        startText.setFont(Font.loadFont(getClass().getResourceAsStream("/fonts/Minecraft.ttf"), 18));
        startText.setFill(Color.LIGHTGRAY);

        Text exitText = createClickableText("Exit", true, () -> exitGame());
        exitText.setFont(Font.loadFont(getClass().getResourceAsStream("/fonts/Minecraft.ttf"), 18));
        exitText.setFill(Color.WHITE);

        layout.getChildren().addAll(titleLabel, startText, exitText);
